package sceneModule.view.wordmap.view 
{
	 ...
	 * @author hao
	 */
	public class ScenePlaceTip extends Label
	{
		...
		public function refresh(city:String, union:String, income:String):void {
