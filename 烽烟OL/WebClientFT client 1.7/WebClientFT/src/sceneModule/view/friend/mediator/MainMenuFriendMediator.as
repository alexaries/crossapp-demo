package sceneModule.view.friend.mediator
{
	 ...
	 * 
	 */	
	public class MainMenuFriendMediator extends Mediator
	{
		[Inject]
		public var comp:MainMenuFriendView;
		[Inject]
		...
		public function MainMenuFriendMediator()
		{
			_cur_page = 1;
			super();
		}
		...
		private function onCloseWindow(evt:MouseEvent):void{
			WindowManager.closeWindow(MainMenuFriendView.NAME,false,false,null,popUpWindowLayer);
		}
