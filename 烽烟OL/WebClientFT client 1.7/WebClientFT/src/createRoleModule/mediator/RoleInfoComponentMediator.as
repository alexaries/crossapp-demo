package createRoleModule.mediator
{
	...
	public class RoleInfoComponentMediator extends Mediator
	{
		[Inject]
		public var comp:RoleInfoComponent;
		...
		public function RoleInfoComponentMediator()
		{
			super();
		}
		
		override public function onRegister():void{
//			comp.radomName.addEventListener(MouseEvent.CLICK,onRadomName);
			comp.submit.addEventListener(MouseEvent.CLICK,onCreateRole);
		}
		
//		private function onRadomName(evt:MouseEvent):void{
...
//		}
		...
		private function onCreateRole(evt:MouseEvent):void{
			...
			request.profession = comp.workType;
