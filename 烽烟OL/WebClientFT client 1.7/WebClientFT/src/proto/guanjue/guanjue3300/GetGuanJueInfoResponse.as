package proto.guanjue.guanjue3300 {
	...
	public final class GetGuanJueInfoResponse extends Message implements IExternalizable {
		...
		private var data_:proto.guanjue.guanjue3300.GuanJueInfo;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.guanjue.guanjue3300.GuanJueInfo):void {
			data_ = value;
		}
		public function get data():proto.guanjue.guanjue3300.GuanJueInfo {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.guanjue.guanjue3300.GuanJueInfo;
