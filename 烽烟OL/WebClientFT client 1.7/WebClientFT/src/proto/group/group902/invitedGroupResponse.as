package proto.group.group902 {
	...
	public final class invitedGroupResponse extends Message implements IExternalizable {
		...
		public function writeExternal(output:IDataOutput):void {
			...
			if (hasData) {
				...
				WriteUtils.write_TYPE_STRING(output, data);
			}
		}
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = ReadUtils.read_TYPE_STRING(input);
					break;
				default:
