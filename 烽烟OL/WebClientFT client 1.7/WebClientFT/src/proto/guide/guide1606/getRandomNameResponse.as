package proto.guide.guide1606 {
	...
	public final class getRandomNameResponse extends Message implements IExternalizable {
		...
		public function writeExternal(output:IDataOutput):void {
			...
			WriteUtils.write_TYPE_INT32(output, result);
			if (hasMessage) {
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 1:
					...
					++resultCount;
					result = ReadUtils.read_TYPE_INT32(input);
					break;
				case 2:
					if (messageCount != 0) {
						throw new IOError('Bad data format.');
