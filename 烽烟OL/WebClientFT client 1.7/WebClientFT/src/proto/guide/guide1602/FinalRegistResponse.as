package proto.guide.guide1602 {
	...
	import proto.guide.guide1602.responseData;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class FinalRegistResponse extends Message implements IExternalizable {
		...
		private var data_:proto.guide.guide1602.responseData;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.guide.guide1602.responseData):void {
			data_ = value;
		}
		public function get data():proto.guide.guide1602.responseData {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.guide.guide1602.responseData;
