package proto.pack.pack223 {
	...
	import proto.pack.pack223.responseData;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class PackageExpansionResponse extends Message implements IExternalizable {
		...
		private var data_:proto.pack.pack223.responseData;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.pack.pack223.responseData):void {
			data_ = value;
		}
		public function get data():proto.pack.pack223.responseData {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.pack.pack223.responseData;
