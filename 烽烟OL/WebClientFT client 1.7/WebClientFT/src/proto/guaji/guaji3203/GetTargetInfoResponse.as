package proto.guaji.guaji3203 {
	...
	public final class GetTargetInfoResponse extends Message implements IExternalizable {
		...
		[ArrayElementType("proto.guaji.guaji3203.DayTaskInfo")]
		public var dayTaskInfo:Array = [];
		public function writeExternal(output:IDataOutput):void {
			...
			for (var dayTaskInfoIndex:uint = 0; dayTaskInfoIndex < dayTaskInfo.length; ++dayTaskInfoIndex) {
				WriteUtils.writeTag(output, WireType.LENGTH_DELIMITED, 3);
				WriteUtils.write_TYPE_MESSAGE(output, dayTaskInfo[dayTaskInfoIndex]);
			}
		}
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 2:
					...
					break;
				case 3:
					dayTaskInfo.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.guaji.guaji3203.DayTaskInfo));
					break;
				default:
