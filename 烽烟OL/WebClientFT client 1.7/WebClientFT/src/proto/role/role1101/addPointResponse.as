package proto.role.role1101 {
	...
	import proto.role.role1101.responseData;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class addPointResponse extends Message implements IExternalizable {
		...
		private var data_:proto.role.role1101.responseData;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.role.role1101.responseData):void {
			data_ = value;
		}
		public function get data():proto.role.role1101.responseData {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.role.role1101.responseData;
