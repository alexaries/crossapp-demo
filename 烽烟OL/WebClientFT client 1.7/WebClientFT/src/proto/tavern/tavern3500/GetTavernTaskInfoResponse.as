package proto.tavern.tavern3500 {
	...
	import proto.tavern.tavern3500.WoW;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class GetTavernTaskInfoResponse extends Message implements IExternalizable {
		...
		private var data_:proto.tavern.tavern3500.WoW;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.tavern.tavern3500.WoW):void {
			data_ = value;
		}
		public function get data():proto.tavern.tavern3500.WoW {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.tavern.tavern3500.WoW;
