package proto.tavern.tavern3503 {
	...
	import proto.tavern.tavern3503.WoW;
	...
	public final class GetTavernTaskInfoResponse extends Message implements IExternalizable {
		...
		private var data_:proto.tavern.tavern3503.WoW;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.tavern.tavern3503.WoW):void {
			data_ = value;
		}
		public function get data():proto.tavern.tavern3503.WoW {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.tavern.tavern3503.WoW;
