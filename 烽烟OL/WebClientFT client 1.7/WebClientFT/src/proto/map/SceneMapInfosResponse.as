package proto.map {
	...
	public final class SceneMapInfosResponse extends Message implements IExternalizable {
		public var result:Boolean;
		public var selfColor:int;
		[ArrayElementType("proto.map.SceneMapInfo")]
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 2:
					...
					break;
				case 3:
					infos.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.map.SceneMapInfo));
					break;
				case 4:
					if (messageCount != 0) {
						throw new IOError('Bad data format.');
