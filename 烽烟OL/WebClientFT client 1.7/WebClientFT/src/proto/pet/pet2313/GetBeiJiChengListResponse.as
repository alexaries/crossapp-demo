package proto.pet.pet2313 {
	...
	public final class GetBeiJiChengListResponse extends Message implements IExternalizable {
		...
		[ArrayElementType("proto.pet.pet2313.PetInfoList")]
		public var petInfoList:Array = [];
		public function writeExternal(output:IDataOutput):void {
			...
			for (var petInfoListIndex:uint = 0; petInfoListIndex < petInfoList.length; ++petInfoListIndex) {
				WriteUtils.writeTag(output, WireType.LENGTH_DELIMITED, 3);
				WriteUtils.write_TYPE_MESSAGE(output, petInfoList[petInfoListIndex]);
			}
		}
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 2:
					...
					break;
				case 3:
					petInfoList.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.pet.pet2313.PetInfoList));
					break;
				default:
