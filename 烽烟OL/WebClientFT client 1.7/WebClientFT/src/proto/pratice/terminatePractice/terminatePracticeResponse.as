package proto.pratice.terminatePractice {
	...
	import proto.pratice.terminatePractice.dataPacket;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class terminatePracticeResponse extends Message implements IExternalizable {
		...
		private var data_:proto.pratice.terminatePractice.dataPacket;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.pratice.terminatePractice.dataPacket):void {
			data_ = value;
		}
		public function get data():proto.pratice.terminatePractice.dataPacket {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.pratice.terminatePractice.dataPacket;
