package proto.pratice.getPratice {
	...
	import proto.pratice.getPratice.dataPacket;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class praticeResponse extends Message implements IExternalizable {
		...
		private var data_:proto.pratice.getPratice.dataPacket;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.pratice.getPratice.dataPacket):void {
			data_ = value;
		}
		public function get data():proto.pratice.getPratice.dataPacket {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.pratice.getPratice.dataPacket;
