package proto.pratice.getRestRoomInfo {
	...
	import proto.pratice.getRestRoomInfo.dataPacket;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class getRestRoomInfoResponse extends Message implements IExternalizable {
		...
		private var data_:proto.pratice.getRestRoomInfo.dataPacket;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.pratice.getRestRoomInfo.dataPacket):void {
			data_ = value;
		}
		public function get data():proto.pratice.getRestRoomInfo.dataPacket {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.pratice.getRestRoomInfo.dataPacket;
