package proto.pratice.restOperate {
	...
	import proto.pratice.restOperate.dataPacket;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class restOperateResponse extends Message implements IExternalizable {
		...
		private var data_:proto.pratice.restOperate.dataPacket;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.pratice.restOperate.dataPacket):void {
			data_ = value;
		}
		public function get data():proto.pratice.restOperate.dataPacket {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.pratice.restOperate.dataPacket;
