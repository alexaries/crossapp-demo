package proto.battle.battle703 {
	...
	public final class InitBattleData extends Message implements IExternalizable {
		...
		private var chaIcon_:int;
		private var hasChaIcon_:Boolean = false;
		public function get hasChaIcon():Boolean {
			return hasChaIcon_;
		}
		public function set chaIcon(value:int):void {
			hasChaIcon_ = true;
			chaIcon_ = value;
		}
		public function get chaIcon():int {
			return chaIcon_;
		}
		private var chatype_:int;
		private var hasChatype_:Boolean = false;
		public function get hasChatype():Boolean {
			return hasChatype_;
		}
		public function set chatype(value:int):void {
			hasChatype_ = true;
			chatype_ = value;
		}
		public function get chatype():int {
			return chatype_;
		}
		...
		public function writeExternal(output:IDataOutput):void {
			...
			if (hasChaIcon) {
				...
				WriteUtils.write_TYPE_INT32(output, chaIcon);
			}
			if (hasChatype) {
				WriteUtils.writeTag(output, WireType.VARINT, 12);
				WriteUtils.write_TYPE_INT32(output, chatype);
			}
		...
		public function readExternal(input:IDataInput):void {
			...
			var chaIconCount:uint = 0;
			var chatypeCount:uint = 0;
			while (input.bytesAvailable != 0) {
				...
				case 11:
					...
					++chaIconCount;
					chaIcon = ReadUtils.read_TYPE_INT32(input);
					break;
				case 12:
					if (chatypeCount != 0) {
						throw new IOError('Bad data format.');
					...
					++chatypeCount;
					chatype = ReadUtils.read_TYPE_INT32(input);
					break;
				case 13:
