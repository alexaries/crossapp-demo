package proto.battle.battle703 {
	...
	import proto.battle.battle703.ResponseData;
	...
	public final class FightResponse extends Message implements IExternalizable {
		...
		private var data_:proto.battle.battle703.ResponseData;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.battle.battle703.ResponseData):void {
			data_ = value;
		}
		public function get data():proto.battle.battle703.ResponseData {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.battle.battle703.ResponseData;
