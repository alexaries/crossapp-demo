package proto.battle.battle712 {
	...
	import proto.battle.battle712.responseData;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class ColonizationFightResponse extends Message implements IExternalizable {
		...
		private var data_:proto.battle.battle712.responseData;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.battle.battle712.responseData):void {
			data_ = value;
		}
		public function get data():proto.battle.battle712.responseData {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.battle.battle712.responseData;
