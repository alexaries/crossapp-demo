package proto.groupBattle.groupBattle4402 {
	...
	public final class GetCityListInfoResponse extends Message implements IExternalizable {
		...
		[ArrayElementType("proto.groupBattle.groupBattle4402.CityInfo")]
		public var cityInfo:Array = [];
		public function writeExternal(output:IDataOutput):void {
			...
			for (var cityInfoIndex:uint = 0; cityInfoIndex < cityInfo.length; ++cityInfoIndex) {
				WriteUtils.writeTag(output, WireType.LENGTH_DELIMITED, 3);
				WriteUtils.write_TYPE_MESSAGE(output, cityInfo[cityInfoIndex]);
			}
		}
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 2:
					...
					break;
				case 3:
					cityInfo.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.groupBattle.groupBattle4402.CityInfo));
					break;
				default:
