package proto.blacksmith.blacksmith2101 {
	...
	import proto.blacksmith.blacksmith2101.Suite;
	...
	public final class ItemsInfo extends Message implements IExternalizable {
		...
		[ArrayElementType("proto.blacksmith.blacksmith2101.Suite")]
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 55:
					...
					break;
				case 56:
					SuiteItems.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.blacksmith.blacksmith2101.Suite));
					break;
				case 57:
