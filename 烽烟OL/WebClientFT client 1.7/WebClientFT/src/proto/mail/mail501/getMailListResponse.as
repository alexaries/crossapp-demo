package proto.mail.mail501 {
	...
	public final class getMailListResponse extends Message implements IExternalizable {
		...
		private var data_:proto.mail.mail501.dataPacket;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.mail.mail501.dataPacket):void {
			data_ = value;
		}
		public function get data():proto.mail.mail501.dataPacket {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.mail.mail501.dataPacket;
