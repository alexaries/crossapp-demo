package proto.mail.mail503 {
	...
	import proto.mail.mail503.dataPacket;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class saveAndDeleteMailResponse extends Message implements IExternalizable {
		...
		private var data_:proto.mail.mail503.dataPacket;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.mail.mail503.dataPacket):void {
			data_ = value;
		}
		public function get data():proto.mail.mail503.dataPacket {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.mail.mail503.dataPacket;
