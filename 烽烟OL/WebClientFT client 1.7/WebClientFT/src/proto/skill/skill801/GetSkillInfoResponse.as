package proto.skill.skill801 {
	...
	import proto.skill.skill801.DataInfo;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class GetSkillInfoResponse extends Message implements IExternalizable {
		...
		private var data_:proto.skill.skill801.DataInfo;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.skill.skill801.DataInfo):void {
			data_ = value;
		}
		public function get data():proto.skill.skill801.DataInfo {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.skill.skill801.DataInfo;
