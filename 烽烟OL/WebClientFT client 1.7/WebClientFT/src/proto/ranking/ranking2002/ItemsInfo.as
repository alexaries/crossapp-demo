package proto.ranking.ranking2002 {
	...
	import proto.ranking.ranking2002.Suite;
	...
	public final class ItemsInfo extends Message implements IExternalizable {
		...
		[ArrayElementType("proto.ranking.ranking2002.Suite")]
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 55:
					...
					break;
				case 56:
					SuiteItems.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.ranking.ranking2002.Suite));
					break;
				case 57:
