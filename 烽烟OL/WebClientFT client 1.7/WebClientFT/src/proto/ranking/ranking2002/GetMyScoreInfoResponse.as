package proto.ranking.ranking2002 {
	...
	public final class GetMyScoreInfoResponse extends Message implements IExternalizable {
		...
		[ArrayElementType("proto.ranking.ranking2002.MyScoreListInfo")]
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 2:
					...
					break;
				case 3:
					data.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.ranking.ranking2002.MyScoreListInfo));
					break;
				default:
