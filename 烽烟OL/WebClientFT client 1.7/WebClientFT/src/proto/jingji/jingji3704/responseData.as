package proto.jingji.jingji3704 {
	...
	public final class responseData extends Message implements IExternalizable {
		...
		[ArrayElementType("proto.jingji.jingji3704.initBattleData")]
		public var startData:Array = [];
		[ArrayElementType("proto.jingji.jingji3704.FightData")]
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 1:
					...
					break;
				case 2:
					startData.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.jingji.jingji3704.initBattleData));
					break;
				case 3:
					stepData.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.jingji.jingji3704.FightData));
					break;
				case 4:
					if (centerXCount != 0) {
						throw new IOError('Bad data format.');
