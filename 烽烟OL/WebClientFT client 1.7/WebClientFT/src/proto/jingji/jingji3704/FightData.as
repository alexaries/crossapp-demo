package proto.jingji.jingji3704 {
	...
	public final class FightData extends Message implements IExternalizable {
		...
		[ArrayElementType("proto.jingji.jingji3704.BuffInfo")]
		...
		[ArrayElementType("proto.jingji.jingji3704.EnemyArray")]
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 12:
					...
					break;
				case 13:
					chaBuffShowList.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.jingji.jingji3704.BuffInfo));
					break;
				case 14:
				...
				case 24:
					...
					break;
				case 25:
					enemyChaArr.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.jingji.jingji3704.EnemyArray));
					break;
				case 26:
