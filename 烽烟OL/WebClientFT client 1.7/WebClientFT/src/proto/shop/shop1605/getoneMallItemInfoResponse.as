package proto.shop.shop1605 {
	...
	import proto.shop.shop1605.responseData;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class getoneMallItemInfoResponse extends Message implements IExternalizable {
		...
		private var data_:proto.shop.shop1605.responseData;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.shop.shop1605.responseData):void {
			data_ = value;
		}
		public function get data():proto.shop.shop1605.responseData {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.shop.shop1605.responseData;
