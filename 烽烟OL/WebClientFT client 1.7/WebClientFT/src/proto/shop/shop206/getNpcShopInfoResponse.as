package proto.shop.shop206 {
	...
	public final class getNpcShopInfoResponse extends Message implements IExternalizable {
		...
		private var data_:proto.shop.shop206.ShopInfo;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.shop.shop206.ShopInfo):void {
			data_ = value;
		}
		public function get data():proto.shop.shop206.ShopInfo {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.shop.shop206.ShopInfo;
