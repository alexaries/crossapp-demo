package proto.commission.commission1203 {
	...
	import proto.commission.commission1203.responseData;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class getGoldPriceTrendsResponse extends Message implements IExternalizable {
		...
		private var data_:proto.commission.commission1203.responseData;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.commission.commission1203.responseData):void {
			data_ = value;
		}
		public function get data():proto.commission.commission1203.responseData {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.commission.commission1203.responseData;
