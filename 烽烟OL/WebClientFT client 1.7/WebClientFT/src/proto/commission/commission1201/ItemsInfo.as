package proto.commission.commission1201 {
	...
	import proto.commission.commission1201.Suite;
	...
	public final class ItemsInfo extends Message implements IExternalizable {
		...
		[ArrayElementType("proto.commission.commission1201.Suite")]
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 55:
					...
					break;
				case 56:
					SuiteItems.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.commission.commission1201.Suite));
					break;
				case 57:
