package proto.resur.resur1706 {
	...
	import proto.resur.resur1706.responseData;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class ReviveTeamMemberResponse extends Message implements IExternalizable {
		...
		public var data:proto.resur.resur1706.responseData;
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.resur.resur1706.responseData;
