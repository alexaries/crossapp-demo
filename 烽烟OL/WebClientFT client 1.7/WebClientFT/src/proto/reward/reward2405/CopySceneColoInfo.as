package proto.reward.reward2405 {
	...
	public final class CopySceneColoInfo extends Message implements IExternalizable {
		...
		[ArrayElementType("proto.reward.reward2405.CopyInfo")]
		public var copyInfo:Array = [];
		public function writeExternal(output:IDataOutput):void {
			...
			for (var copyInfoIndex:uint = 0; copyInfoIndex < copyInfo.length; ++copyInfoIndex) {
				WriteUtils.writeTag(output, WireType.LENGTH_DELIMITED, 3);
				WriteUtils.write_TYPE_MESSAGE(output, copyInfo[copyInfoIndex]);
			}
		}
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 2:
					...
					break;
				case 3:
					copyInfo.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.reward.reward2405.CopyInfo));
					break;
				default:
