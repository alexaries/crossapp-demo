package proto.zudui.zudui4302 {
	...
	public final class GetDuiWuInfoResponse extends Message implements IExternalizable {
		...
		[ArrayElementType("proto.zudui.zudui4302.PosRoleInfo")]
		public var posRoleInfo:Array = [];
		public function writeExternal(output:IDataOutput):void {
			...
			for (var posRoleInfoIndex:uint = 0; posRoleInfoIndex < posRoleInfo.length; ++posRoleInfoIndex) {
				WriteUtils.writeTag(output, WireType.LENGTH_DELIMITED, 3);
				WriteUtils.write_TYPE_MESSAGE(output, posRoleInfo[posRoleInfoIndex]);
			}
		}
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 2:
					...
					break;
				case 3:
					posRoleInfo.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.zudui.zudui4302.PosRoleInfo));
					break;
				default:
