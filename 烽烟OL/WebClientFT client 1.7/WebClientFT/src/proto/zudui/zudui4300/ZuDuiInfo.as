package proto.zudui.zudui4300 {
	...
	public final class ZuDuiInfo extends Message implements IExternalizable {
		...
		[ArrayElementType("proto.zudui.zudui4300.DuiWuInfo")]
		public var duiWuInfo:Array = [];
		public function writeExternal(output:IDataOutput):void {
			...
			for (var duiWuInfoIndex:uint = 0; duiWuInfoIndex < duiWuInfo.length; ++duiWuInfoIndex) {
				WriteUtils.writeTag(output, WireType.LENGTH_DELIMITED, 3);
				WriteUtils.write_TYPE_MESSAGE(output, duiWuInfo[duiWuInfoIndex]);
			}
		}
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 2:
					...
					break;
				case 3:
					duiWuInfo.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.zudui.zudui4300.DuiWuInfo));
					break;
				default:
