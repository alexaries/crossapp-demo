package proto.zudui.zudui4308 {
	...
	public final class responseData extends Message implements IExternalizable {
		...
		[ArrayElementType("proto.zudui.zudui4308.initBattleData")]
		public var startData:Array = [];
		[ArrayElementType("proto.zudui.zudui4308.FightData")]
		...
		private var zyid_:int;
		private var hasZyid_:Boolean = false;
		public function get hasZyid():Boolean {
			return hasZyid_;
		}
		public function set zyid(value:int):void {
			hasZyid_ = true;
			zyid_ = value;
		}
		public function get zyid():int {
			return zyid_;
		}
		public function writeExternal(output:IDataOutput):void {
			...
			if (hasZyid) {
				...
				WriteUtils.write_TYPE_INT32(output, zyid);
			}
		}
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 1:
					...
					break;
				case 2:
					startData.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.zudui.zudui4308.initBattleData));
					break;
				case 3:
					stepData.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.zudui.zudui4308.FightData));
					break;
				case 4:
					if (centerXCount != 0) {
						throw new IOError('Bad data format.');
				...
				case 8:
					...
					++zyidCount;
					zyid = ReadUtils.read_TYPE_INT32(input);
					break;
				default:
