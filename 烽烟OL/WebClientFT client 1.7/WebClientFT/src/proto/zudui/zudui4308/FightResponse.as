package proto.zudui.zudui4308 {
	...
	import proto.zudui.zudui4308.responseData;
	...
	public final class FightResponse extends Message implements IExternalizable {
		...
		private var data_:proto.zudui.zudui4308.responseData;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.zudui.zudui4308.responseData):void {
			data_ = value;
		}
		public function get data():proto.zudui.zudui4308.responseData {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.zudui.zudui4308.responseData;
