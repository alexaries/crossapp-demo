package proto.zudui.zudui4303 {
	...
	public final class JoinDuiWuResponse extends Message implements IExternalizable {
		...
		private var rdwId_:int;
		private var hasRdwId_:Boolean = false;
		public function get hasRdwId():Boolean {
			return hasRdwId_;
		}
		public function set rdwId(value:int):void {
			hasRdwId_ = true;
			rdwId_ = value;
		}
		public function get rdwId():int {
			return rdwId_;
		}
		public function writeExternal(output:IDataOutput):void {
			...
			if (hasRdwId) {
				...
				WriteUtils.write_TYPE_INT32(output, rdwId);
			}
		}
		public function readExternal(input:IDataInput):void {
			var messageCount:uint = 0;
			var resultCount:uint = 0;
			var rdwIdCount:uint = 0;
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++rdwIdCount;
					rdwId = ReadUtils.read_TYPE_INT32(input);
					break;
				default:
