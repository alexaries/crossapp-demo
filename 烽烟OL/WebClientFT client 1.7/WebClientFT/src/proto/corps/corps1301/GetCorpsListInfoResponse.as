package proto.corps.corps1301 {
	...
	public final class GetCorpsListInfoResponse extends Message implements IExternalizable {
		...
		private var data_:proto.corps.corps1301.CorpsListInfo;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.corps.corps1301.CorpsListInfo):void {
			data_ = value;
		}
		public function get data():proto.corps.corps1301.CorpsListInfo {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.corps.corps1301.CorpsListInfo;
