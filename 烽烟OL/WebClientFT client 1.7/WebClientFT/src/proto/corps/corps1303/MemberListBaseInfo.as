package proto.corps.corps1303 {
	...
	public final class MemberListBaseInfo extends Message implements IExternalizable {
		...
		private var onlineState_:String;
		public function get hasOnlineState():Boolean {
			return null != onlineState_;
		}
		public function set onlineState(value:String):void {
			onlineState_ = value;
		}
		public function get onlineState():String {
			return onlineState_;
		}
		...
		public function writeExternal(output:IDataOutput):void {
			...
			if (hasOnlineState) {
				...
				WriteUtils.write_TYPE_STRING(output, onlineState);
			}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 5:
					...
					break;
				case 6:
					if (onlineStateCount != 0) {
						throw new IOError('Bad data format.');
					}
					++onlineStateCount;
					onlineState = ReadUtils.read_TYPE_STRING(input);
					break;
				case 7:
