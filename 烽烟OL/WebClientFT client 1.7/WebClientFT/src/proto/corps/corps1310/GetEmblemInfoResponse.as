package proto.corps.corps1310 {
	...
	public final class GetEmblemInfoResponse extends Message implements IExternalizable {
		...
		private var data_:proto.corps.corps1310.EmblemInfo;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.corps.corps1310.EmblemInfo):void {
			data_ = value;
		}
		public function get data():proto.corps.corps1310.EmblemInfo {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.corps.corps1310.EmblemInfo;
