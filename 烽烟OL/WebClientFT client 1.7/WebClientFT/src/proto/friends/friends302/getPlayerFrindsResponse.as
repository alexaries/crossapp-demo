package proto.friends.friends302 {
	...
	public final class getPlayerFrindsResponse extends Message implements IExternalizable {
		...
		private var data_:proto.friends.friends302.Friends;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.friends.friends302.Friends):void {
			data_ = value;
		}
		public function get data():proto.friends.friends302.Friends {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.friends.friends302.Friends;
