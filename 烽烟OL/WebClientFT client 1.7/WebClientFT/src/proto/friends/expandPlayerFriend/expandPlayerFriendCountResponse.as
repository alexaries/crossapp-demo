package proto.friends.expandPlayerFriend {
	...
	import proto.friends.expandPlayerFriend.dataPacket;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class expandPlayerFriendCountResponse extends Message implements IExternalizable {
		...
		private var data_:proto.friends.expandPlayerFriend.dataPacket;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.friends.expandPlayerFriend.dataPacket):void {
			data_ = value;
		}
		public function get data():proto.friends.expandPlayerFriend.dataPacket {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.friends.expandPlayerFriend.dataPacket;
