package proto.friends.friends305 {
	...
	import proto.friends.friends305.Friend;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class Friends extends Message implements IExternalizable {
		[ArrayElementType("proto.friends.friends305.Friend")]
		...
		public function readExternal(input:IDataInput):void {
			while (input.bytesAvailable != 0) {
				...
				switch (tag.number) {
				case 1:
					friends.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.friends.friends305.Friend));
					break;
				default:
