package proto.friends.friends305 {
	...
	import proto.friends.friends305.Friends;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class searchCharacterByNameResponse extends Message implements IExternalizable {
		...
		private var data_:proto.friends.friends305.Friends;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.friends.friends305.Friends):void {
			data_ = value;
		}
		public function get data():proto.friends.friends305.Friends {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.friends.friends305.Friends;
