package proto.chat.chat1007 {
	...
	import proto.chat.chat1007.SettingInfo;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class GetChatSettingInfoResponse extends Message implements IExternalizable {
		...
		private var data_:proto.chat.chat1007.SettingInfo;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.chat.chat1007.SettingInfo):void {
			data_ = value;
		}
		public function get data():proto.chat.chat1007.SettingInfo {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.chat.chat1007.SettingInfo;
