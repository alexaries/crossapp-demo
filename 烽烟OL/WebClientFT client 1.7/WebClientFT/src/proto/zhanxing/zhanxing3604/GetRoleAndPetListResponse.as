package proto.zhanxing.zhanxing3604 {
	...
	public final class GetRoleAndPetListResponse extends Message implements IExternalizable {
		...
		[ArrayElementType("proto.zhanxing.zhanxing3604.RoleAndPetInfo")]
		public var roleAndPetInfo:Array = [];
		public function writeExternal(output:IDataOutput):void {
			...
			for (var roleAndPetInfoIndex:uint = 0; roleAndPetInfoIndex < roleAndPetInfo.length; ++roleAndPetInfoIndex) {
				WriteUtils.writeTag(output, WireType.LENGTH_DELIMITED, 3);
				WriteUtils.write_TYPE_MESSAGE(output, roleAndPetInfo[roleAndPetInfoIndex]);
			}
		}
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 2:
					...
					break;
				case 3:
					roleAndPetInfo.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.zhanxing.zhanxing3604.RoleAndPetInfo));
					break;
				default:
