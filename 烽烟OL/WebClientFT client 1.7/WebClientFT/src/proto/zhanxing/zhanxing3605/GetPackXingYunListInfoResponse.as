package proto.zhanxing.zhanxing3605 {
	...
	public final class GetPackXingYunListInfoResponse extends Message implements IExternalizable {
		...
		[ArrayElementType("proto.zhanxing.zhanxing3605.PackInfo")]
		public var xyPackList:Array = [];
		public function writeExternal(output:IDataOutput):void {
			...
			for (var xyPackListIndex:uint = 0; xyPackListIndex < xyPackList.length; ++xyPackListIndex) {
				WriteUtils.writeTag(output, WireType.LENGTH_DELIMITED, 3);
				WriteUtils.write_TYPE_MESSAGE(output, xyPackList[xyPackListIndex]);
			}
		}
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 2:
					...
					break;
				case 3:
					xyPackList.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.zhanxing.zhanxing3605.PackInfo));
					break;
				default:
