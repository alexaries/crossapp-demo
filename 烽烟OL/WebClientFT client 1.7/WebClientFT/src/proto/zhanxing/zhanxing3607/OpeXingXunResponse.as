package proto.zhanxing.zhanxing3607 {
	...
	public final class OpeXingXunResponse extends Message implements IExternalizable {
		...
		private var oType_:int;
		private var hasOType_:Boolean = false;
		public function get hasOType():Boolean {
			return hasOType_;
		}
		public function set oType(value:int):void {
			hasOType_ = true;
			oType_ = value;
		}
		public function get oType():int {
			return oType_;
		}
		public function writeExternal(output:IDataOutput):void {
			...
			if (hasOType) {
				...
				WriteUtils.write_TYPE_INT32(output, oType);
			}
		}
		public function readExternal(input:IDataInput):void {
			var messageCount:uint = 0;
			var resultCount:uint = 0;
			var oTypeCount:uint = 0;
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++oTypeCount;
					oType = ReadUtils.read_TYPE_INT32(input);
					break;
				default:
