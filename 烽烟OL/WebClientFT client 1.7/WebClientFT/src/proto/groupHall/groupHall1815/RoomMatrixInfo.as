package proto.groupHall.groupHall1815 {
	...
	import proto.groupHall.groupHall1815.FrontEye;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class RoomMatrixInfo extends Message implements IExternalizable {
		...
		[ArrayElementType("proto.groupHall.groupHall1815.FrontEye")]
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 4:
					...
					break;
				case 5:
					frontEyeList.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.groupHall.groupHall1815.FrontEye));
					break;
				default:
