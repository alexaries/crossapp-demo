package proto.groupHall.groupHall1801 {
	...
	import proto.groupHall.groupHall1801.GroupInfo;
	...
	public final class GetGroupInfoResponse extends Message implements IExternalizable {
		...
		private var data_:proto.groupHall.groupHall1801.GroupInfo;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.groupHall.groupHall1801.GroupInfo):void {
			data_ = value;
		}
		public function get data():proto.groupHall.groupHall1801.GroupInfo {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.groupHall.groupHall1801.GroupInfo;
