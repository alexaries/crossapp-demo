package proto.scene.scene210 {
	...
	public final class equipEquipmentResponse extends Message implements IExternalizable {
		...
		private var usetype_:int;
		private var hasUsetype_:Boolean = false;
		...
		public function writeExternal(output:IDataOutput):void {
			...
			if (hasUsetype) {
				...
				WriteUtils.write_TYPE_INT32(output, usetype);
			}
		}
		public function readExternal(input:IDataInput):void {
			var resultCount:uint = 0;
			var messageCount:uint = 0;
			var usetypeCount:uint = 0;
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++usetypeCount;
					usetype = ReadUtils.read_TYPE_INT32(input);
					break;
				default:
