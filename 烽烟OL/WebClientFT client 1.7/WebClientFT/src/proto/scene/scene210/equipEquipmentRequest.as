package proto.scene.scene210 {
	...
	public final class equipEquipmentRequest extends Message implements IExternalizable {
		public var id:int;
		public var fromPosition:int;
		public var toPosition:int;
		public var fromPackCategory:int;
		...
		public function writeExternal(output:IDataOutput):void {
			...
			WriteUtils.write_TYPE_INT32(output, fromPackCategory);
		...
		public function readExternal(input:IDataInput):void {
			...
			var fromPackCategoryCount:uint = 0;
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					break;
				case 4:
					if (fromPackCategoryCount != 0) {
						throw new IOError('Bad data format.');
					}
					++fromPackCategoryCount;
					fromPackCategory = ReadUtils.read_TYPE_INT32(input);
					break;
				case 5:
					if (curpageCount != 0) {
						throw new IOError('Bad data format.');
