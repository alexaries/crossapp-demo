package proto.scene.getPlayerInfo {
	...
	import proto.scene.getPlayerInfo.roleInfo;
	...
	public final class getPlayerInfoResponse extends Message implements IExternalizable {
		...
		private var data_:proto.scene.getPlayerInfo.roleInfo;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.scene.getPlayerInfo.roleInfo):void {
			data_ = value;
		}
		public function get data():proto.scene.getPlayerInfo.roleInfo {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.scene.getPlayerInfo.roleInfo;
