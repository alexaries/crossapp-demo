package proto.scene.scene201 {
	...
	import proto.scene.scene201.CorpsInfo;
	import proto.scene.scene201.Appellation;
	...
	public final class roleInfo extends Message implements IExternalizable {
		...
		private var appellation_:proto.scene.scene201.Appellation;
		public function get hasAppellation():Boolean {
			return null != appellation_;
		}
		public function set appellation(value:proto.scene.scene201.Appellation):void {
			appellation_ = value;
		}
		public function get appellation():proto.scene.scene201.Appellation {
			return appellation_;
		}
		[ArrayElementType("proto.scene.scene201.Appellation")]
		public var appellationList:Array = [];
		private var corpsInfo_:proto.scene.scene201.CorpsInfo;
		public function get hasCorpsInfo():Boolean {
			return null != corpsInfo_;
		}
		public function set corpsInfo(value:proto.scene.scene201.CorpsInfo):void {
			corpsInfo_ = value;
		}
		public function get corpsInfo():proto.scene.scene201.CorpsInfo {
			return corpsInfo_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 35:
					...
					++appellationCount;
					appellation = new proto.scene.scene201.Appellation;
					ReadUtils.read_TYPE_MESSAGE(input, appellation);
					break;
				case 36:
					appellationList.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.scene.scene201.Appellation));
					break;
				case 37:
					if (corpsInfoCount != 0) {
						throw new IOError('Bad data format.');
					...
					++corpsInfoCount;
					corpsInfo = new proto.scene.scene201.CorpsInfo;
