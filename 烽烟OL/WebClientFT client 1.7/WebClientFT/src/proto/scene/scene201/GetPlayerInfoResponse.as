package proto.scene.scene201 {
	...
	public final class GetPlayerInfoResponse extends Message implements IExternalizable {
		...
		private var data_:proto.scene.PlayerPropertyInfo;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.scene.PlayerPropertyInfo):void {
			data_ = value;
		}
		public function get data():proto.scene.PlayerPropertyInfo {
			return data_;
		}
		private var buyCount_:int;
		private var hasBuyCount_:Boolean = false;
		...
		public function writeExternal(output:IDataOutput):void {
			...
			if (hasBuyCount) {
				...
				WriteUtils.write_TYPE_INT32(output, buyCount);
			}
		}
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.scene.PlayerPropertyInfo;
				...
				case 4:
					...
					++buyCountCount;
					buyCount = ReadUtils.read_TYPE_INT32(input);
					break;
				default:
