package proto.scene.scene221 {
	...
	import proto.scene.scene221.ResponseInfoData;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class GetOtherRoleInfoResponse extends Message implements IExternalizable {
		...
		private var data_:proto.scene.scene221.ResponseInfoData;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.scene.scene221.ResponseInfoData):void {
			data_ = value;
		}
		public function get data():proto.scene.scene221.ResponseInfoData {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.scene.scene221.ResponseInfoData;
