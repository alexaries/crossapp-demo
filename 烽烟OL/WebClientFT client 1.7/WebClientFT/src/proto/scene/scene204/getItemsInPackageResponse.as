package proto.scene.scene204 {
	...
	import proto.scene.scene204.responseData;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class getItemsInPackageResponse extends Message implements IExternalizable {
		...
		private var data_:proto.scene.scene204.responseData;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.scene.scene204.responseData):void {
			data_ = value;
		}
		public function get data():proto.scene.scene204.responseData {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.scene.scene204.responseData;
