package proto.scene.immediateRefreshShopItems {
	...
	public final class immediateRefreshShopItemsRequest extends Message implements IExternalizable {
		public var id:int;
		...
		public function writeExternal(output:IDataOutput):void {
			...
			WriteUtils.write_TYPE_INT32(output, payCount);
		}
		public function readExternal(input:IDataInput):void {
			var idCount:uint = 0;
			var placeIdCount:uint = 0;
			var payTypeCount:uint = 0;
			var payCountCount:uint = 0;
			while (input.bytesAvailable != 0) {
				...
				case 4:
					...
					++payCountCount;
					payCount = ReadUtils.read_TYPE_INT32(input);
					break;
				default:
