package proto.scene.immediateRefreshShopItems {
	...
	import proto.scene.immediateRefreshShopItems.attributeEffect;
	...
	public final class extraAttribute extends Message implements IExternalizable {
		...
		[ArrayElementType("proto.scene.immediateRefreshShopItems.attributeEffect")]
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 6:
					...
					break;
				case 7:
					attributeEffects.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.scene.immediateRefreshShopItems.attributeEffect));
					break;
				default:
