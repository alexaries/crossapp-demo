package proto.scene.immediateRefreshShopItems {
	...
	import proto.scene.immediateRefreshShopItems.extraAttribute;
	import proto.scene.immediateRefreshShopItems.itemTemplate;
	...
	public final class Item extends Message implements IExternalizable {
		...
		[ArrayElementType("proto.scene.immediateRefreshShopItems.extraAttribute")]
		...
		private var itemTemplateInfo_:proto.scene.immediateRefreshShopItems.itemTemplate;
		public function get hasItemTemplateInfo():Boolean {
			return null != itemTemplateInfo_;
		}
		public function set itemTemplateInfo(value:proto.scene.immediateRefreshShopItems.itemTemplate):void {
			itemTemplateInfo_ = value;
		}
		public function get itemTemplateInfo():proto.scene.immediateRefreshShopItems.itemTemplate {
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 7:
					...
					break;
				case 8:
					extraAttributeList.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.scene.immediateRefreshShopItems.extraAttribute));
					break;
				case 9:
					if (nameCount != 0) {
						throw new IOError('Bad data format.');
				...
				case 11:
					...
					itemTemplateInfo = new proto.scene.immediateRefreshShopItems.itemTemplate;
