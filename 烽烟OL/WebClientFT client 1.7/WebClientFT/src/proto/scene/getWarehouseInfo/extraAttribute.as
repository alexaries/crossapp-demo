package proto.scene.getWarehouseInfo {
	...
	import proto.scene.getWarehouseInfo.attributeEffect;
	...
	public final class extraAttribute extends Message implements IExternalizable {
		...
		[ArrayElementType("proto.scene.getWarehouseInfo.attributeEffect")]
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 6:
					...
					break;
				case 7:
					attributeEffects.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.scene.getWarehouseInfo.attributeEffect));
					break;
				default:
