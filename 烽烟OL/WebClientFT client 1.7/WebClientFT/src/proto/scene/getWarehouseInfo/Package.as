package proto.scene.getWarehouseInfo {
	import com.netease.protobuf.*;
	import flash.utils.IExternalizable;
	import flash.utils.IDataOutput;
	import flash.utils.IDataInput;
	import flash.errors.IOError;
	import proto.scene.getWarehouseInfo.extraAttribute;
	import proto.scene.getWarehouseInfo.itemTemplate;
	...
	public final class Package extends Message implements IExternalizable {
		...
		[ArrayElementType("proto.scene.getWarehouseInfo.extraAttribute")]
		...
		private var itemTemplateInfo_:proto.scene.getWarehouseInfo.itemTemplate;
		public function get hasItemTemplateInfo():Boolean {
			return null != itemTemplateInfo_;
		}
		public function set itemTemplateInfo(value:proto.scene.getWarehouseInfo.itemTemplate):void {
			itemTemplateInfo_ = value;
		}
		public function get itemTemplateInfo():proto.scene.getWarehouseInfo.itemTemplate {
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 7:
					...
					break;
				case 8:
					extraAttributeList.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.scene.getWarehouseInfo.extraAttribute));
					break;
				case 9:
					if (nameCount != 0) {
						throw new IOError('Bad data format.');
				...
				case 11:
					...
					itemTemplateInfo = new proto.scene.getWarehouseInfo.itemTemplate;
