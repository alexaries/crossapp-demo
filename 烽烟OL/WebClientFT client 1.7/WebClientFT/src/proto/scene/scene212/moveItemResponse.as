package proto.scene.scene212 {
	...
	import proto.scene.scene212.responseData;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class moveItemResponse extends Message implements IExternalizable {
		...
		private var data_:proto.scene.scene212.responseData;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.scene.scene212.responseData):void {
			data_ = value;
		}
		public function get data():proto.scene.scene212.responseData {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.scene.scene212.responseData;
