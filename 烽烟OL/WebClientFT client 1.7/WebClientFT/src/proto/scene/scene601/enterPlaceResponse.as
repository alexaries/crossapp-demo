package proto.scene.scene601 {
	...
	import proto.scene.scene601.enterPlaceData;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class enterPlaceResponse extends Message implements IExternalizable {
		...
		private var data_:proto.scene.scene601.enterPlaceData;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.scene.scene601.enterPlaceData):void {
			data_ = value;
		}
		public function get data():proto.scene.scene601.enterPlaceData {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.scene.scene601.enterPlaceData;
