package proto.calendar {
	...
	import proto.calendar.CalendarTaskInfo;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class GetCalendarTaskInfoResponse extends Message implements IExternalizable {
		...
		private var data_:proto.calendar.CalendarTaskInfo;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.calendar.CalendarTaskInfo):void {
			data_ = value;
		}
		public function get data():proto.calendar.CalendarTaskInfo {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.calendar.CalendarTaskInfo;
