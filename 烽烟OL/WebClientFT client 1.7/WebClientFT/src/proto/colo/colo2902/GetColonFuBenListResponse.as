package proto.colo.colo2902 {
	...
	public final class GetColonFuBenListResponse extends Message implements IExternalizable {
		...
		[ArrayElementType("proto.colo.colo2902.ColoFuBenInfo")]
		public var fuBenlist:Array = [];
		public function writeExternal(output:IDataOutput):void {
			...
			for (var fuBenlistIndex:uint = 0; fuBenlistIndex < fuBenlist.length; ++fuBenlistIndex) {
				WriteUtils.writeTag(output, WireType.LENGTH_DELIMITED, 4);
				WriteUtils.write_TYPE_MESSAGE(output, fuBenlist[fuBenlistIndex]);
			}
		}
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					break;
				case 4:
					fuBenlist.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.colo.colo2902.ColoFuBenInfo));
					break;
				default:
