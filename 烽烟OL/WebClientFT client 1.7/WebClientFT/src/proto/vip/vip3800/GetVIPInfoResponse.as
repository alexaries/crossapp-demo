package proto.vip.vip3800 {
	...
	import proto.vip.vip3800.ResponseDate;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class GetVIPInfoResponse extends Message implements IExternalizable {
		...
		private var data_:proto.vip.vip3800.ResponseDate;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.vip.vip3800.ResponseDate):void {
			data_ = value;
		}
		public function get data():proto.vip.vip3800.ResponseDate {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.vip.vip3800.ResponseDate;
