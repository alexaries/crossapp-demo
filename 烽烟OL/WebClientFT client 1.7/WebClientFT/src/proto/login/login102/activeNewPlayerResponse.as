package proto.login.login102 {
	...
	import proto.login.login102.userInfo;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class activeNewPlayerResponse extends Message implements IExternalizable {
		...
		private var data_:proto.login.login102.userInfo;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.login.login102.userInfo):void {
			data_ = value;
		}
		public function get data():proto.login.login102.userInfo {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.login.login102.userInfo;
