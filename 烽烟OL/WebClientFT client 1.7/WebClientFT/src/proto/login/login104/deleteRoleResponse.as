package proto.login.login104 {
	...
	import proto.login.login104.userInfo;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class deleteRoleResponse extends Message implements IExternalizable {
		...
		private var data_:proto.login.login104.userInfo;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.login.login104.userInfo):void {
			data_ = value;
		}
		public function get data():proto.login.login104.userInfo {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.login.login104.userInfo;
