package proto.login.login103 {
	...
	import proto.login.login103.roleInfo;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class roleLoginResponse extends Message implements IExternalizable {
		...
		private var data_:proto.login.login103.roleInfo;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.login.login103.roleInfo):void {
			data_ = value;
		}
		public function get data():proto.login.login103.roleInfo {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.login.login103.roleInfo;
