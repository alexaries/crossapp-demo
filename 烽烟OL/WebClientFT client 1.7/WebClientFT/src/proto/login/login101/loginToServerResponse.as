package proto.login.login101 {
	...
	import proto.login.login101.userInfo;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class loginToServerResponse extends Message implements IExternalizable {
		...
		private var data_:proto.login.login101.userInfo;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.login.login101.userInfo):void {
			data_ = value;
		}
		public function get data():proto.login.login101.userInfo {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.login.login101.userInfo;
