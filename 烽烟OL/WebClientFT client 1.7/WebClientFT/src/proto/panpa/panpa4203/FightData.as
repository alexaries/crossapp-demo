package proto.panpa.panpa4203 {
	...
	public final class FightData extends Message implements IExternalizable {
		...
		[ArrayElementType("proto.panpa.panpa4203.BuffInfo")]
		...
		[ArrayElementType("proto.panpa.panpa4203.EnemyArray")]
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 12:
					...
					break;
				case 13:
					chaBuffShowList.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.panpa.panpa4203.BuffInfo));
					break;
				case 14:
				...
				case 24:
					...
					break;
				case 25:
					enemyChaArr.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.panpa.panpa4203.EnemyArray));
					break;
				case 26:
