package proto.panpa.panpa4203 {
	...
	import proto.panpa.panpa4203.responseData;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class TowerBattleResponse extends Message implements IExternalizable {
		...
		private var data_:proto.panpa.panpa4203.responseData;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.panpa.panpa4203.responseData):void {
			data_ = value;
		}
		public function get data():proto.panpa.panpa4203.responseData {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.panpa.panpa4203.responseData;
