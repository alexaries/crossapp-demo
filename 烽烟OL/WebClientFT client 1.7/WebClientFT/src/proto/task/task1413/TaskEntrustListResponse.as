package proto.task.task1413 {
	...
	public final class TaskEntrustListResponse extends Message implements IExternalizable {
		public var result:Boolean;
		public var npcId:int;
		public var npcDes:String;
		...
		public function writeExternal(output:IDataOutput):void {
			...
			WriteUtils.write_TYPE_STRING(output, npcDes);
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++npcDesCount;
					npcDes = ReadUtils.read_TYPE_STRING(input);
					break;
				case 4:
