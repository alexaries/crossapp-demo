package proto.task.task1403 {
	import com.netease.protobuf.*;
	import flash.utils.IExternalizable;
	import flash.utils.IDataOutput;
	import flash.utils.IDataInput;
	import flash.errors.IOError;
	import proto.task.task1403.TaskInfo;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class commitQuestResponse extends Message implements IExternalizable {
		...
		private var data_:proto.task.task1403.TaskInfo;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.task.task1403.TaskInfo):void {
			data_ = value;
		}
		public function get data():proto.task.task1403.TaskInfo {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.task.task1403.TaskInfo;
