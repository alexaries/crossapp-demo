package proto.task.task1409 {
	...
	import proto.task.task1409.ResponseData;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class getQuestInfoResponse extends Message implements IExternalizable {
		...
		private var data_:proto.task.task1409.ResponseData;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.task.task1409.ResponseData):void {
			data_ = value;
		}
		public function get data():proto.task.task1409.ResponseData {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.task.task1409.ResponseData;
