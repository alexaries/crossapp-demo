package proto.task.task1409 {
	...
	import proto.task.task1409.Suite;
	...
	public final class ItemsInfo extends Message implements IExternalizable {
		...
		[ArrayElementType("proto.task.task1409.Suite")]
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 55:
					...
					break;
				case 56:
					SuiteItems.push(ReadUtils.read_TYPE_MESSAGE(input, new proto.task.task1409.Suite));
					break;
				case 57:
