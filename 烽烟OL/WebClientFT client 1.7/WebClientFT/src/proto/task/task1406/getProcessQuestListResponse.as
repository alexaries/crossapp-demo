package proto.task.task1406 {
	...
	import proto.task.task1406.responseData;
	// @@protoc_insertion_point(imports)
	// @@protoc_insertion_point(class_metadata)
	public final class getProcessQuestListResponse extends Message implements IExternalizable {
		...
		private var data_:proto.task.task1406.responseData;
		public function get hasData():Boolean {
			return null != data_;
		}
		public function set data(value:proto.task.task1406.responseData):void {
			data_ = value;
		}
		public function get data():proto.task.task1406.responseData {
			return data_;
		}
		...
		public function readExternal(input:IDataInput):void {
			...
			while (input.bytesAvailable != 0) {
				...
				case 3:
					...
					++dataCount;
					data = new proto.task.task1406.responseData;
