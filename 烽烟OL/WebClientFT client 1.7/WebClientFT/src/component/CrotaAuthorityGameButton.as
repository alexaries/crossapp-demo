package component
{
	...
	import style.Skin_CrotaAnthorityButton;
	
	public class CrotaAuthorityGameButton extends Button
	{
		public function CrotaAuthorityGameButton()
		{
			super();
			initButtonStyle();
		}
		private function initButtonStyle():void{
			setStyle("skinClass",Skin_CrotaAnthorityButton);
