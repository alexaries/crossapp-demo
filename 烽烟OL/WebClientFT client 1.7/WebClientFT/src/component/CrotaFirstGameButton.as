package component
{
	...
	import style.Skin_CrotaFirstButton;
	
	public class CrotaFirstGameButton extends Button
	{
		public function CrotaFirstGameButton()
		{
			super();
			initButtonStyle();
		}
		private function initButtonStyle():void{
			setStyle("skinClass",Skin_CrotaFirstButton);
