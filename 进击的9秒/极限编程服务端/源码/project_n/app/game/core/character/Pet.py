...
class Pet:
    ...
    def updateSkill(self, space, skill_id):
        """更新伙伴的技能设置
        """
        _skill_space_name = "skill_%d"%space
        setattr(self, _skill_space_name, skill_id)
        _pet_mmode = tbpetadmin.getObj(self._pid)
        _pet_mmode.update_multi({_skill_space_name:skill_id})
